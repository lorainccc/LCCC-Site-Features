		...
		if ( ( $new == 'pending' ) ){
			...
			for ($i = 0; $i <=count($admins); $i++){
				...
				$notify = get_user_meta( $user->ID, 'postnotice', true );
					...
					//determine the post type and change the label accordingly.				
				switch ($post->post_type) {
					...
					case "post":
					 $pending_type = "Post";
						break;
					case "lccc_announcement":
						$pending_type = "Announcement";
					 break;
					case "lccc_events":
					 $pending_type = "Event";
						break;
				...
				$subject = '[' . $site_title . '] ' . $pending_type . ' Pending Approval';
				...
				$body = '<img src="http://www.lorainccc.edu/wp-content/themes/lorainccc/images/LCCC-Logo.png" style="width:285px; height:59px;"><br/><h1 style="font-size: 16pt;font-family:sans-serif;">Page Approval Notice</h1><p style="font-size: 12pt;font-family:sans-serif;">A pending revision to the "' . $pending_type . ": " . $post->post_title . '" </p><p style="font-size: 12pt;font-family:sans-serif;">It was submitted by ' . $submitted_by . '.</p><p style="font-size: 12pt;font-family:sans-serif;">Review it here:<a href="' . $edit_page_url . '" target="_blank">' . $edit_page_url . '</a></p>';
