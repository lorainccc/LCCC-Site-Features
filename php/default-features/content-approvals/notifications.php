	...
	function lc_approval_notify($new, $old, $post){
		if ( ( $new == 'pending' ) ){
			...
			for ($i = 0; $i <=count($admins); $i++){
				...
				$body = '<img src="http://www.lorainccc.edu/wp-content/themes/lorainccc/images/LCCC-Logo.png" style="width:285px; height:59px;"><br/><h1 style="font-size: 16pt;font-family:sans-serif;">Page Approval Notice</h1><p style="font-size: 12pt;font-family:sans-serif;">A pending revision to the Page "' . $post->post_title . '" </p><p style="font-size: 12pt;font-family:sans-serif;">It was submitted by ' . $current_user->user_firstname . ' ' . $current_user->user_lastname . '.</p><p style="font-size: 12pt;font-family:sans-serif;">Review it here:<a href="' . $edit_page_url . '" target="_blank">' . $edit_page_url . '</a></p>';
