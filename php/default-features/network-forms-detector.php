  ...
  $sites = get_sites();
   ...
   foreach ( $sites as $site ){
    ...
    foreach( $page_ids as $page ){
     ...
     if ($form != ''){
       echo '<li><a href="'. admin_url() .'post.php?post=' . $page . '&action=edit" target="_blank">'  . get_the_title( $page ) . '</a> - <a href="http://lorainccc.firmstep.com/default.aspx' . $form . '" target="_blank">View Form at Firmstep</a></li>';
      $countForms++;
      $form_content = true;
      } 
    }
