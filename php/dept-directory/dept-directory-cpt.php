...
function lc_department_directory() {
	...
	$labels = array(
		'name'                  => _x( 'LCCC Department Directory', 'Post Type General Name', 'lorainccc' ),
		'singular_name'         => _x( 'LCCC Department Directory', 'Post Type Singular Name', 'lorainccc' ),
		'menu_name'             => __( 'Department Directory', 'lorainccc' ),
		'name_admin_bar'        => __( 'Department Directory', 'lorainccc' ),
		'archives'              => __( 'Department Directory Archives', 'lorainccc' ),
		'parent_item_colon'     => __( 'Parent Item:', 'lorainccc' ),
		'all_items'             => __( 'All Directory Entries', 'lorainccc' ),
		'add_new_item'          => __( 'Add New Directory Entry', 'lorainccc' ),
		'add_new'               => __( 'Add New Directory Entry', 'lorainccc' ),
		'new_item'              => __( 'New Item Directory Entry', 'lorainccc' ),
		'edit_item'             => __( 'Edit Directory Entry', 'lorainccc' ),
		'update_item'           => __( 'Update Directory Entry', 'lorainccc' ),
		'view_item'             => __( 'View Directory Entry', 'lorainccc' ),
		'search_items'          => __( 'Search Directory Entry', 'lorainccc' ),
		'not_found'             => __( 'Directory Entry Not found', 'lorainccc' ),
		'not_found_in_trash'    => __( 'Directory Entry Not found in Trash', 'lorainccc' ),
		...
		'insert_into_item'      => __( 'Insert into Directory Entry', 'lorainccc' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Directory Entry', 'lorainccc' ),
		'items_list'            => __( 'Directory Entry list', 'lorainccc' ),
		'items_list_navigation' => __( 'Directory Entry list navigation', 'lorainccc' ),
		'filter_items_list'     => __( 'Filter Directory Entry items list', 'lorainccc' ),
	);

	$args = array(
		'label'                 => __( 'LCCC Department Directory Entry', 'lorainccc' ),
		'description'           => __( 'LCCC Department Directory', 'lorainccc' ),
		'labels'                => $labels,
