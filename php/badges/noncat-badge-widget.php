...
class Badge_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		//$widgetcategory = $instance['category'];
			$badge_orientation = $instance['badgeorientation'];	
  ...
  <?php
   ...
   // Fields
     		$instance['numberofposts'] = strip_tags($new_instance['numberofposts']);
							$instance['badgeorientation'] = strip_tags($new_instance['badgeorientation']);
...
if( $instance) {
					...
					$badgeorientation = esc_attr($instance['badgeorientation']);
...
<p>
<label for="<?php echo $this->get_field_id('badgeorientation'); ?>"><?php _e('Badge Orientation', 'wp_widget_plugin'); ?></label>
<select name="<?php echo $this->get_field_name('badgeorientation'); ?>" id="<?php echo $this->get_field_id('badgeorientation'); ?>">
<?php
